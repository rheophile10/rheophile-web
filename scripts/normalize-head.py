...
"""Apply site-wide <head> conventions to every content page (idempotent):
  ...
  3. Add the privacy-friendly Plausible analytics <script> before </head>.
...
ANALYTICS = '<script defer data-domain="rheophile.ca" src="https://plausible.io/js/script.js"></script>'
